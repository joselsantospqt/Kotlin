...
import com.example.applicationalertaperigo.databinding.ActivityLoginBinding
import com.example.applicationalertaperigo.ui.home.HomeActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun setupButton() {
        ...
        binding.btnLogin.setOnClickListener {
            logarFirebase(binding.textInputLogin.text.toString(), binding.textInputSenha.text.toString())
